...
class RailButton(Component):
    ...
    def validate(self):
        ...
        # self._dragCoefficient = (0.0, "")
        self.validateNonNegative(self._screwMass[0], "Screw Mass invalid")
        ...
        self.validateNonEmptyString(self._screwMass[1], "Screw Mass Units invalid '%s" % self._screwMass[1])
