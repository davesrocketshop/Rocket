...
from femsolver.calculix import write_constraint_centrif as con_centrif
from femsolver.calculix import write_constraint_contact as con_contact
from femsolver.calculix import write_constraint_displacement as con_displacement
from femsolver.calculix import write_constraint_fixed as con_fixed
from femsolver.calculix import write_constraint_fluidsection as con_fluidsection
from femsolver.calculix import write_constraint_force as con_force
from femsolver.calculix import write_constraint_heatflux as con_heatflux
from femsolver.calculix import write_constraint_initialtemperature as con_itemp
from femsolver.calculix import write_constraint_planerotation as con_planerotation
from femsolver.calculix import write_constraint_pressure as con_pressure
from femsolver.calculix import write_constraint_sectionprint as con_sectionprint
from femsolver.calculix import write_constraint_selfweight as con_selfweight
from femsolver.calculix import write_constraint_temperature as con_temperature
from femsolver.calculix import write_constraint_tie as con_tie
from femsolver.calculix import write_constraint_transform as con_transform
...
class FemInputWriterCcx(writerbase.FemInputWriter):
    ...
    def write_solver_input(self):
        ...
        FreeCAD.Console.PrintMessage("Rocket CalculiX solver input writing...\n")
        FreeCAD.Console.PrintMessage(
            "Input file:{}\n"
        ...
        # step equation
        WriteStepEquation.write_step_equation(inpfile, self)
        ...
        WriteStepEquation.write_step_end(inpfile, self)
