...
from Ui.TaskPanelSolverCalculix import TaskPanelSolverCalculix


class ViewProviderSolverCalculix(view_base_femconstraint.VPBaseFemConstraint):
    """
