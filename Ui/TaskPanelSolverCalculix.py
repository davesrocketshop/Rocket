...
class TaskPanelSolverCalculix:
    ...
    def __init__(self, solver_object):
        self.form = FreeCADGui.PySideUic.loadUi(
            FreeCAD.getUserAppDataDir() + "Mod/Rocket/Resources/ui/SolverCalculix.ui"
        )

        from Rocket.fem.CcxTools import CcxTools as ccx
    ...
    def update(self):
        ...
        self.form.sb_mode_count.setValue(self.fea.solver.EigenmodesCount)
        return
    ...
    def set_mode_count(self, value):
        if self.fea.solver.EigenmodesCount != value:
            self.fea.solver.EigenmodesCount = value
